...
cudnn_benchmark = True
# 续训配置（按epoch续训）
# MMEngine 中 resume_from 已废弃，请使用 load_from + resume=True
...
resume = True  # 启用续训
work_dir = '/home/featurize/work/mmsegmentation_25717_mine/mmsegmentation/work_dirs_A/dinov3_swin_upernet_swinmainE_A2_resume'
# 续训配置（按epoch续训）


print('DEBUG_RESUME_VALUE =', resume)
