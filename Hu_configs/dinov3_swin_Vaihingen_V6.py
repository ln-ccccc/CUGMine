# ============================================================
# dinov3_swin_Vaihingen_V6.py
# 基于 V2，只修改损失函数为 CE + Lovasz（验证性实验）数据集还是6类
# ============================================================
...
cudnn_benchmark = True
work_dir = '/home/featurize/work/mmsegmentation_25717_mine/mmsegmentation/work_dirs/dinov3_swin_Vaihingen_V6'