...
model = dict(
    auxiliary_head=dict(
        ...
        loss_decode=[
            dict(
                ...
                use_sigmoid=False),
            dict(loss_weight=1.0, per_image=True, type='LovaszLoss'),
        ],
    ...
    backbone=dict(
        ...
        swin_cfg=dict(
            ...
            init_cfg=dict(
                checkpoint=
                '/home/featurize/work/mmsegmentation_25717_mine/mmsegmentation/swin_base_patch4_window7_224_20220317-e9b98025.pth',
                type='Pretrained'),
            mlp_ratio=4,
        ...
        custom_keys=dict(
            {
                ...
                'backbone.feature_adapt_layers': dict(
                    decay_mult=1.0, lr_mult=0.1),
...
work_dir = '/home/featurize/work/mmsegmentation_25717_mine/mmsegmentation/work_dirs/dino_swin_retrain_from_ep89_precision_v4'
