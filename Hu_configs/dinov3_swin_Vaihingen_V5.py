# ============================================================
# dinov3_swin_Vaihingen_V5.py
# 基于 V2，只修改损失函数为 CE + Lovasz（验证性实验）数据集去掉了clutter
# ============================================================
...
cudnn_benchmark = True
work_dir = '/home/featurize/work/mmsegmentation_25717_mine/mmsegmentation/work_dirs/dinov3_swin_Vaihingen_V5'