...
optim_wrapper = dict(
    ...
    optimizer=dict(
        betas=(0.9, 0.999),
        eps=1e-08,
        lr=8e-6,  # 按epoch训练时学习率通常与iter保持一致，通过总轮次调整
        type='AdamW',
        weight_decay=0.05
    ),
    paramwise_cfg=dict(
...
cudnn_benchmark = True
work_dir = '/home/featurize/work/mmsegmentation_25717_mine/mmsegmentation/work_dirs/dinov3_swin_upernet_swinmainE_finetune30_sched'
