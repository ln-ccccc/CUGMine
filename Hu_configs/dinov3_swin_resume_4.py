    ...
    auxiliary_head=dict(
        ...
        loss_decode=[
            dict(
                ...
                use_sigmoid=False,
                loss_weight=0.7,
                class_weight=[1.0, 1.0, 2.0, 1.1, 1.5, 2.5]  # 顺序按你表：grassland, forest, building, road, bareground, water
            ),
...
cudnn_benchmark = True
work_dir = '/home/featurize/work/mmsegmentation_25717_mine/mmsegmentation/work_dirs/dino_swin_precision_calib_from_ep9'