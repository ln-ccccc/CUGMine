...
default_hooks = dict(
    checkpoint=dict(
        ...
        save_best='mIoU',
        type='CheckpointHook',
        # out_dir='/home/featurize/checkpoints_dinov3'   # ← 新增这一行（本地磁盘）
    ),
...
cudnn_benchmark = True
# 续训配置（按epoch续训）
load_from='/home/featurize/work/mmsegmentation_25717_mine/mmsegmentation/work_dirs_A3/dinov3_swin_upernet_swinmainE_A3_resume/epoch_27.pth'
resume = True  # 启用续训

work_dir = '/home/featurize/work/mmsegmentation_25717_mine/mmsegmentation/work_dirs_A3/dinov3_swin_upernet_swinmainE_A3_resume'